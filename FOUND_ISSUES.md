...
## 9. 弹药经济崩溃导致游戏无法进行 💀 致命
**问题**：游戏在第3-4波时弹药耗尽，玩家无法射击、无法完成波次、游戏完全卡死
**位置**：游戏数值平衡设计
...
**原因分析**：
弹药消耗 > 弹药掉落，导致资源持续减少：
- 武器消耗：weapon1(1/发) + weapon2(5/发) ≈ 每波100-160弹药
- 敌人掉落：每个敌人5红色资源 ≈ 每波50-80弹药
- 第1波后剩余：150（-50）
- 第2波后剩余：90（-60）
- 第3波后剩余：20（-70）
- 第4波：弹药耗尽，游戏卡死 ❌
...
2. **减少武器消耗**（-40%~50%）
   - weapon_basic_1: ammoCost 1 → 0.5
   - weapon_heavy_1: ammoCost 5 → 3

**修复后效果**：
- 第1波：消耗80，掉落150，净+70（之前净-50）
- 第2波：消耗96，掉落180，净+84（之前净-60）
- 第3波：消耗112，掉落210，净+98（之前净-70）
- ✅ 现在弹药持续增长，即使不采集资源也能完成所有波次
